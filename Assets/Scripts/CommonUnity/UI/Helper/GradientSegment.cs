...
{
    [AddComponentMenu("UI/CustomEffects/GradientSegment")]
    public class GradientSegment : BaseMeshEffect
    {
        ...
        [SerializeField]
        private GradientType gradientType = GradientType.TopToBottom;
        ...
        public override void ModifyMesh(VertexHelper vh)
        {
            ...
            if (cahceRectTransform == null)
            {
                ...
                limitDistance = gradientType == GradientType.TopToBottom ? cahceRectTransform.rect.height : cahceRectTransform.rect.width;
            ...
            if (gradientType == GradientType.TopToBottom)
            {
                if (count > 0)
                {
